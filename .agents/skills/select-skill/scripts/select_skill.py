...
ROUTE_HINTS = {
    ...
    "sales conversion": ("amma-sales-conversion",),
    "sales material": ("amma-sales-conversion",),
    "pitch": ("amma-sales-conversion", "sales"),
    "flyer": ("amma-sales-conversion", "visual-director"),
    "objection handling": ("amma-sales-conversion", "sales"),
    "follow up copy": ("amma-sales-conversion", "sales"),
    "restaurant owner": ("amma-sales-conversion", "amma-business-intelligence"),
    "amma ventures": ("amma-business-intelligence",),
    "morning command": ("amma-business-intelligence",),
    "revenue power hour": ("amma-business-intelligence",),
    "daily closeout": ("amma-business-intelligence",),
    "restaurant leads": ("amma-business-intelligence",),
    "business bottleneck": ("amma-business-intelligence",),
    "business automation": ("amma-business-intelligence",),
    "always learning": ("amma-business-intelligence",),
