...
| P0 | New-client delivery | Verified: `$199` offer, owner/access runbooks, QR registry, intake packet, and draft delivery SOP/checklists exist in PR #216 | Review the standard, then field-test it on the first approved client without skipping G0–G8 | Delivery Owner | days from approved scope to verified owner acceptance | Client creation, access, print purchase, send, merge, deploy | Ready for review |
