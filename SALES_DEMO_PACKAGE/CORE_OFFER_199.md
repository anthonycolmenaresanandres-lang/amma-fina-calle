# Fina Calle Core Offer — $199 Starting Point

This is the pricing and scope source for buyer-facing restaurant materials.
...
The written proposal defines setup, launch timing, update limits, and recurring terms before approval. Printing, table-specific service, promotions, analytics reports, custom game art or mechanics, and other custom work are scoped and priced separately.
...
- Verified live proof: `https://finacalleos.com/m/colattao`
- Playable game-engine demo: `https://finacalleos.com/penalty-shootout`
- Owner sign-in proof: `https://finacalleos.com/owner/colattao` — show sign-in only.
- Voluntary next action: **Request the $199/month plan in writing.**

## Sales experiment IDs

- `hook_id`: `H-MENU-CONTROL-01`
- `proof_id`: `P-LIVE-MENU-DEMO-OWNER-01`
