# Bodega Cafe Review Identity + Game Style

**Status:** pending owner approval  
**Prepared:** July 22, 2026  
**Use boundary:** unlinked, noindex owner-review surfaces only
...
## Bodega Sessions game lock

- **Format:** 15-20 second typical play, three deterministic rhythm-memory rounds.
- **Signals:** Cup, Steam, Bell, Bass; abstract circles and waveform only.
- **Audio:** muted by default; four original Web Audio oscillator tones; no song, artist recording, or external audio file.
- **Result language:** `Headliner`, `On beat`, or `Warm-up set`, based only on beats repeated correctly.
- **CTA:** music/event action remains disabled until the owner supplies one verified event title and destination.
- **Fallback:** the complete game renders from Phaser primitives and system text without loading a logo, photograph, music file, or sprite.
- **Accessibility:** touch controls, HTML control equivalents, keys 1-4, visible focus, responsive resize, and reduced-motion-safe cue treatment.
